...
fn main() -> Result<(), BuildError> {
    ...
    const SHADERS: &[SimpleSource] = &[
        ...
        SimpleSource {
            path: "src/inject.frag",
            kind: ShaderKind::Fragment,
            entry: "main",
            name_overwrite: None,
        },
        SimpleSource {
            path: "src/linear.frag",
            kind: ShaderKind::Fragment,
            entry: "main",
            name_overwrite: None,
        },
        ...
        SimpleSource {
            path: "src/distribution_normal2d.frag",
            kind: ShaderKind::Fragment,
            entry: "main",
            name_overwrite: None,
        },
        SimpleSource {
            path: "src/fractal_noise.frag",
            kind: ShaderKind::Fragment,
            entry: "main",
            name_overwrite: None,
        },
        SimpleSource {
            path: "src/palette.frag",
            kind: ShaderKind::Fragment,
            entry: "main",
            name_overwrite: None,
        },
        SimpleSource {
            path: "src/bilinear.frag",
            kind: ShaderKind::Fragment,
            entry: "main",
            name_overwrite: None,
        },
